...
RUN cd /home/workspace && wget -nv  http://downloads.typesafe.com/scala/2.11.7/scala-2.11.7.tgz && tar zxf scala-2.11.7.tgz  && rm -f scala-2.11.7.tgz && ln -s scala-2.11.7 scala
